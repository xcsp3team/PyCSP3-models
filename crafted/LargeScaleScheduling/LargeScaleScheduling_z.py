...
The original MZN model was proposed by the BeCool team at UCLouvain - no licence was explicitly mentioned (MIT Licence is assumed).
...
## Execution
  ...
  python LargeScaleScheduling.py -data=<datafile.dzn> -parser=LargeScaleScheduling_ParserZ.py
