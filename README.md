...
In this repository, you will find **more than 300 models** for various kinds of problems, from frameworks known as CSP (Constraint Satisfaction Problem) and COP (
