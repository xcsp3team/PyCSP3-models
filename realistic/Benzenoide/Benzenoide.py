...
neighbors = [[valid(
    ...
    for j in range(widths[i])] for i in W]
...
satisfy(
    ...
    [
        [x >= x[symmetry] for symmetry in [sym.apply_on(n) for sym in TypeHexagonSymmetry]],  # if sym.is_rotation()]
