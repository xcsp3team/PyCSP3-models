...
data['load_per_period'] = OrderedDict([("min", number_in(next_line())), ("max", number_in(next_line()))])
data['courses_per_period'] = OrderedDict([("min", number_in(next_line())), ("max", number_in(next_line()))])
